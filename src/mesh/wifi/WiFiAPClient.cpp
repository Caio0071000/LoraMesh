...
{   
    ...
    if (config.network.wifi_enabled) {
        ...
        // Definindo o SSID e a senha diretamente no código
        strcpy(config.network.wifi_ssid, "POCO X3 NFC");  // Defina o SSID fixo
        strcpy(config.network.wifi_psk, "depoiseudigo"); // Defina a senha fixa
